...
- [AI for Database](https://aifordatabase.com) – AI-powered natural language interface for databases, enabling plain-English queries, self-refreshing dashboards, and workflow automation.
